...
from SakkuMusic.utils.formatters import alpha_to_int
    ...
    if "-nobot" not in message.text:
        ...
        try:
            await message.reply_text(
                f"Broadcasted messages to {sent} chats with {pin} pins from the bot."
            )
        except:
            pass
    ...
    if "-user" in message.text:
        ...
        for i in served_users:
            try:
                ...
                continue
        try:
            await message.reply_text(f"Broadcasted messsge to {susr} users.")
        except:
            pass
